    ...
    <header className="sticky top-0 z-50 w-full bg-[#0a0c10]/90 backdrop-blur-md border-b border-white/[0.08] transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2.5 sm:gap-3.5 group text-left cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 rounded-lg p-1 shrink-0"
        >
          <ChurchLogo size={40} className="sm:hidden shrink-0" />
          <ChurchLogo size={46} className="hidden sm:flex shrink-0" />
          <div className="flex flex-col justify-center">
            <span className="text-base sm:text-lg font-bold tracking-tight text-white group-hover:text-amber-400 transition-colors whitespace-nowrap">
              AD Araras Sede
            </span>
          </div>
        </button>
        ...
        <div className="flex items-center gap-2 sm:gap-3 shrink-0">
          ...
          <button
            ...
            className="lg:hidden p-1.5 sm:p-2 text-slate-300 hover:text-white hover:bg-white/[0.05] rounded-lg transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 cursor-pointer"
